...
__export(platform_exports, {
  PolarDBPlatform: () => PolarDBPlatform,
  applyMigrationOptionsSchema: () => applyMigrationOptionsSchema,
  ...
  generateTypescriptTypesResultSchema: () => generateTypescriptTypesResultSchema,
  getLogsOptionsSchema: () => getLogsOptionsSchema,
