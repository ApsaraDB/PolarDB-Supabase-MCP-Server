...
__export(index_exports, {
  createSupabaseApiPlatform: () => createSupabaseApiPlatform,
  createSupabaseMcpServer: () => createSupabaseMcpServer,
...
function createSupabaseApiPlatform(options) {
  ...
  const platform = {
    ...
    async getEdgeFunction(projectId, functionSlug) {
      ...
      const entrypoint_path = edgeFunction.entrypoint_path ? (0, import_posix.relative)(
        pathPrefix,
        (0, import_node_url.fileURLToPath)(edgeFunction.entrypoint_path, { windows: false })
      ) : void 0;
      const import_map_path = edgeFunction.import_map_path ? (0, import_posix.relative)(
        pathPrefix,
        (0, import_node_url.fileURLToPath)(edgeFunction.import_map_path, { windows: false })
      ) : void 0;
      ...
      for await (const part of parts) {
        if (part.isFile && part.filename) {
          files.push({
            name: (0, import_posix.relative)(pathPrefix, part.filename),
            content: part.text
          });
        }
      }
